...
public class Mapjoin_mapper extends Mapper<LongWritable, Text, Text, Text> 
{
	...
	@Override
	protected void map(LongWritable key, Text line, Mapper<LongWritable, Text, Text, Text>.Context context) throws IOException, InterruptedException 
	{
		...
		String reviewtext = fields[3].trim();
