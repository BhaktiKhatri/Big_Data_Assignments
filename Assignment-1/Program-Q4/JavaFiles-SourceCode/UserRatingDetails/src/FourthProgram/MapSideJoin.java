...
//-----------------------------------------------------------------------------------------
		...
		//job2.setReducerClass(Mapjoin_reducer.class);
		...
		String inrev="/user/brk160030/review.csv";
		Path inputFileRev = new Path(inrev);
		
		FileInputFormat.addInputPath(job2, inputFileRev);
