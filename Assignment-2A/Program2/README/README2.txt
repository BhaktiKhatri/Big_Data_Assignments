...
esc :wq
pig
Now type the source code from file question2program.pig
After dump I;
Remove the outputfile if it exists by: fs -rmr /user/brk160030/program2output;
Store the result into a file to your directory by: store I into '/user/brk160030/program2output';
The file is stored at HDFS. The file can be viewed by: fs -cat /user/brk160030/program2output/part-r-00000;
Store the file from HDFS to Linux by: fs -get /user/brk160030/program2output /home/010/b/br/brk160030;
Copy the output file 'program2output' from Linux to your system using WinSCP.
Click on part-r-00000 file inside program2output to view the output.
