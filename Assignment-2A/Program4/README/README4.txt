...
esc :wq
pig
Now type the source code from file question4program.pig
After dump G;
Remove the outputfile if it exists by: fs -rmr /user/brk160030/program4output;
Store the result into a file to your directory by: store G into '/user/brk160030/program4output';
The file is stored at HDFS. The file can be viewed by: fs -cat /user/brk160030/program4output/part-r-00000;
Store the file from HDFS to Linux by: fs -get /user/brk160030/program4output /home/010/b/br/brk160030;
Copy the output file 'program4output' from Linux to your system using WinSCP.
Click on part-r-00000 file inside program4output to view the output.
